import { ACTIVE_PERMISSION_KEYS, ROLE_PERMISSION_MAP, PERMISSION_METADATA } from '../../constants/permission.constant.js'
...
export const ensureRbacSeedData = async () => {
  const permissionKeys = ACTIVE_PERMISSION_KEYS
