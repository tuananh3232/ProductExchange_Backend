    ...
    schemas: {
      ...
      Product: {
        ...
        properties: {
          ...
          style: { type: 'string', enum: ['minimalist', 'modern', 'vintage', 'luxury', 'korean', 'bohemian'], nullable: true },
          roomType: { type: 'string', enum: ['bedroom', 'living_room', 'kitchen', 'workspace'], nullable: true },
          colorTone: { type: 'string', enum: ['warm', 'cool', 'neutral', 'dark', 'bright'], nullable: true },
          decorRole: { type: 'string', enum: ['main_item', 'lighting', 'wall_decor', 'textile', 'accent_item', 'fragrance'], nullable: true },
